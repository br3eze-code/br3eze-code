...
function activate(context) {
  ...
  // Run arbitrary skill
  context.subscriptions.push(
    vscode.commands.registerCommand('agentos.runSkill', async () => {
  ...
  // Quick commands
  context.subscriptions.push(
    vscode.commands.registerCommand('agentos.memory', async () => {
  ...
  context.subscriptions.push(
    vscode.commands.registerCommand('agentos.onboardAll', async () => {
  ...
  context.subscriptions.push(
    vscode.commands.registerCommand('agentos.hotspotBrand', async () => {
  ...
  context.subscriptions.push(
    vscode.commands.registerCommand('agentos.recordUi', async () => {
      const url = await vscode.window.showInputBox({
        prompt: 'URL to record on',
        value: 'https://',
      });
      if (!url) return;
  ...
  context.subscriptions.push(
    vscode.commands.registerCommand('agentos.runUiAgent', async () => {
      ...
      try {
        ...
        return vscode.window.showErrorMessage('Invalid JSON in active editor');
      }
...
class SkillsProvider {
  ...
  getChildren() {
    return [
      ...
      i.command = { command: 'agentos.runSkill', title: i.label };
      return i;
    });
  }
}
