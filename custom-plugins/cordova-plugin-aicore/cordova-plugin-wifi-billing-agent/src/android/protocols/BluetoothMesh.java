...
public class BluetoothMesh {
    ...
    public void shutdown() {
        if (advertiser != null) advertiser.stopAdvertising((android.bluetooth.le.AdvertiseCallback) null);
        if (scanner != null) scanner.stopScan((android.bluetooth.le.ScanCallback) null);
