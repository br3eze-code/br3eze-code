...
class UniversalAICoordinator {
  ...
  loadToolSchemas() {
    ...
    const schemas = {
      ...
      network: [
        ...
        {
          name: 'voucher.create',
          description: 'Create access voucher',
          params: ['plan', 'duration'],
        },
      ],
      ...
      cloud: [
        ...
        {
          name: 'vm.scale',
          description: 'Scale VM resources',
          params: ['instanceId', 'cpu', 'memory'],
        },
  ...
  buildSystemPrompt() {
    const capabilities = this.toolSchemas
      .map(
        t =>
