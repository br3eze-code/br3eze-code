    ...
    .action(async (options) => {
      ...
      const { aiCompany } = await prompt({
        ...
        default: (() => {
          ...
          const map = { gemini: 'google', gemma: 'google', openai: 'openai', anthropic: 'anthropic',
            llama: 'meta', deepseek: 'deepseek', groq: 'groq', together: 'together',
            openrouter: 'openrouter', xai: 'xai', moonshot: 'moonshot', minimax: 'minimax',
            ollama: 'local' };
          return map[p] || 'google';
        })()
      });
      ...
      const MODEL_MAP = {
        ...
        google: [
          { value: 'gemini-3.5-flash',               name: '★  gemini-3.5-flash               — latest Flash (May 2026)' },
          { value: 'gemini-3.1-pro',                 name: '   gemini-3.1-pro                 — strongest reasoning' },
          { value: 'gemini-3-pro',                   name: '   gemini-3-pro                   — stable flagship' },
          { value: 'gemini-3.1-flash-lite',          name: '⚡  gemini-3.1-flash-lite           — cheapest / high-volume' },
          { value: 'gemini-2.5-pro',                 name: '   gemini-2.5-pro                 [LEGACY] paid tier' },
          { value: 'gemini-2.5-flash',               name: '   gemini-2.5-flash               [LEGACY] paid tier' },
          { value: 'gemini-2.5-flash-preview-05-20', name: '   gemini-2.5-flash-preview-05-20 [LEGACY] pinned' },
          { value: 'gemini-2.5-pro-preview-06-05',   name: '   gemini-2.5-pro-preview-06-05   [LEGACY] pinned' },
          { value: 'gemini-2.0-flash',               name: '   gemini-2.0-flash               [DEPRECATED] shut down Jun 2026' },
          { value: 'gemini-2.0-flash-lite',          name: '   gemini-2.0-flash-lite          [DEPRECATED] shut down Jun 2026' },
          { value: 'gemini-1.5-pro',                 name: '   gemini-1.5-pro                 [DEPRECATED] retiring' },
          { value: 'gemini-1.5-flash',               name: '   gemini-1.5-flash               [DEPRECATED] retiring' },
        ...
        // ── OpenAI ───────────────────────────────────────────────────────────
        openai: [
          { value: 'gpt-5.4',                        name: '★  gpt-5.4                        — current standard (1M ctx)' },
          { value: 'gpt-5.4-pro',                    name: '   gpt-5.4-pro                    — max capability' },
          { value: 'gpt-5.4-mini',                   name: '⚡  gpt-5.4-mini                   — fast & affordable' },
          { value: 'gpt-5.4-nano',                   name: '⚡  gpt-5.4-nano                   — ultra-cheap / bulk' },
          { value: 'gpt-4o',                         name: '   gpt-4o                         [LEGACY] retired from ChatGPT' },
          ...
          { value: 'o3',                             name: '🧠  o3                              [DEPRECATED] retired from picker' },
          ...
          { value: 'gpt-3.5-turbo',                  name: '   gpt-3.5-turbo                  [DEPRECATED] hard EOL' },
        ],

        // ── Anthropic ────────────────────────────────────────────────────────
        anthropic: [
          { value: 'claude-opus-4-8',                name: '★  claude-opus-4-8                — latest Opus (Jun 2026)' },
          { value: 'claude-sonnet-4-6',              name: '★  claude-sonnet-4-6              — workhorse / 90% of tasks' },
          ...
          { value: 'claude-3-7-sonnet-20250219',     name: '   claude-3-7-sonnet-20250219    [LEGACY]' },
          { value: 'claude-3-5-sonnet-20241022',     name: '   claude-3-5-sonnet-20241022    [LEGACY] Claude 3.5' },
          { value: 'claude-3-5-haiku-20241022',      name: '   claude-3-5-haiku-20241022     [LEGACY]' },
          { value: 'claude-3-opus-20240229',         name: '   claude-3-opus-20240229        [DEPRECATED]' },
          { value: 'claude-3-sonnet-20240229',       name: '   claude-3-sonnet-20240229      [DEPRECATED]' },
          { value: 'claude-3-haiku-20240307',        name: '   claude-3-haiku-20240307       [DEPRECATED]' },
          { value: 'claude-2.1',                     name: '   claude-2.1                    [DEPRECATED]' },
        ],

        // ── Meta Llama (hosted on Groq for speed or Together for variety) ────
        meta: [
          { value: 'meta-llama/Llama-4-Maverick-17B-128E-Instruct-FP8', name: '★  Llama 4 Maverick 17B 128E FP8 (Together) — MoE flagship' },
          { value: 'meta-llama/Llama-4-Scout-17B-16E-Instruct',          name: '   Llama 4 Scout 17B 16E (Together) — efficient MoE' },
          ...
          { value: 'meta-llama/Meta-Llama-3.1-405B-Instruct-Turbo',     name: '   Llama 3.1 405B (Together) — max quality' },
          { value: 'meta-llama/Llama-3.2-90B-Vision-Instruct-Turbo',    name: '   Llama 3.2 90B Vision (Together)' },
          { value: 'meta-llama/Llama-3.2-11B-Vision-Instruct-Turbo',    name: '   Llama 3.2 11B Vision (Together) — light multimodal' },
          { value: 'meta-llama/Meta-Llama-3.1-70B-Instruct-Turbo',      name: '   Llama 3.1 70B (Together)               [LEGACY]' },
          { value: 'llama-3.1-70b-versatile',                           name: '   Llama 3.1 70B (Groq)                   [LEGACY]' },
          { value: 'llama3-70b-8192',                                    name: '   Llama 3 70B (Groq)                     [DEPRECATED]' },
          { value: 'llama3-8b-8192',                                     name: '   Llama 3 8B (Groq)                      [DEPRECATED]' },
        ],

        // ── DeepSeek ─────────────────────────────────────────────────────────
        deepseek: [
          { value: 'deepseek-v4-pro',                name: '★  deepseek-v4-pro                — 1.6T MoE · 1M ctx (Apr 2026)' },
          { value: 'deepseek-v4-flash',              name: '⚡  deepseek-v4-flash              — 284B · cost-efficient' },
          { value: 'deepseek-v3',                    name: '   deepseek-v3                    [LEGACY] Dec 2024 flagship' },
          { value: 'deepseek-chat',                  name: '   deepseek-chat                  [DEPRECATED] alias retiring Jul 24 2026' },
          { value: 'deepseek-reasoner',              name: '🧠  deepseek-reasoner              [DEPRECATED] alias retiring Jul 24 2026' },
        ...
        groq: [
          { value: 'llama-3.3-70b-versatile',        name: '★  llama-3.3-70b-versatile        — top reasoning + speed' },
          { value: 'llama-3.1-8b-instant',           name: '⚡  llama-3.1-8b-instant           — ultra-fast · low cost' },
          { value: 'openai/gpt-oss-120b',            name: '   openai/gpt-oss-120b            — OpenAI OSS 120B via Groq' },
          { value: 'openai/gpt-oss-20b',             name: '⚡  openai/gpt-oss-20b             — OpenAI OSS 20B fast' },
          { value: 'gemma2-9b-it',                   name: '   gemma2-9b-it                   — Google Gemma 2 9B' },
          { value: 'mixtral-8x7b-32768',             name: '   mixtral-8x7b-32768             — Mistral MoE' },
          { value: 'whisper-large-v3-turbo',         name: '   whisper-large-v3-turbo         — fast speech-to-text' },
          { value: 'whisper-large-v3',               name: '   whisper-large-v3               — accurate speech-to-text' },
        ...
        together: [
          { value: 'meta-llama/Llama-4-Maverick-17B-128E-Instruct-FP8', name: '★  Llama 4 Maverick 17B 128E FP8   — MoE flagship' },
          { value: 'meta-llama/Llama-4-Scout-17B-16E-Instruct',          name: '   Llama 4 Scout 17B 16E           — efficient MoE' },
          { value: 'Qwen/Qwen3.6-Plus',                                  name: '★  Qwen 3.6 Plus                    — latest Qwen 2026' },
          { value: 'Qwen/Qwen3.5-397B-A17B',                            name: '   Qwen 3.5 397B A17B              — MoE massive' },
          { value: 'Qwen/Qwen3.5-9B',                                    name: '⚡  Qwen 3.5 9B                      — fast & cheap' },
          { value: 'deepseek-ai/DeepSeek-V4-Pro',                       name: '   DeepSeek-V4-Pro               (via Together)' },
          { value: 'deepseek-ai/DeepSeek-R1',                           name: '🧠  DeepSeek-R1                    (via Together, reasoning)' },
          { value: 'meta-llama/Llama-3.3-70B-Instruct-Turbo',           name: '   Llama 3.3 70B Turbo' },
          { value: 'meta-llama/Meta-Llama-3.1-405B-Instruct-Turbo',     name: '   Llama 3.1 405B Turbo            — max quality' },
          { value: 'meta-llama/Llama-3.2-90B-Vision-Instruct-Turbo',    name: '   Llama 3.2 90B Vision            — multimodal' },
          { value: 'Qwen/Qwen2.5-72B-Instruct-Turbo',                   name: '   Qwen 2.5 72B Turbo             [LEGACY]' },
          { value: 'deepseek-ai/DeepSeek-V3',                           name: '   DeepSeek-V3                    [LEGACY]' },
          { value: 'mistralai/Mixtral-8x22B-Instruct-v0.1',             name: '   Mixtral 8x22B                  [LEGACY]' },
          { value: 'mistralai/Mixtral-8x7B-Instruct-v0.1',              name: '   Mixtral 8x7B                   [LEGACY]' },
        ],

        // ── OpenRouter (400+ models from 70+ providers, one API key) ─────────
        openrouter: [
          { value: 'anthropic/claude-opus-4-8',      name: '★  Claude Opus 4.8 (Anthropic)    — latest flagship' },
          { value: 'anthropic/claude-sonnet-4-6',    name: '★  Claude Sonnet 4.6 (Anthropic)  — workhorse' },
          { value: 'anthropic/claude-haiku-4-5',     name: '⚡  Claude Haiku 4.5 (Anthropic)   — cheap' },
          { value: 'openai/gpt-5.4',                 name: '★  GPT-5.4 (OpenAI)               — latest standard' },
          { value: 'openai/gpt-5.4-pro',             name: '   GPT-5.4 Pro (OpenAI)           — max capability' },
          { value: 'openai/gpt-5.4-mini',            name: '⚡  GPT-5.4 Mini (OpenAI)          — fast' },
          { value: 'google/gemini-3.5-flash',        name: '★  Gemini 3.5 Flash (Google)       — latest Flash' },
          ...
          { value: 'openrouter/auto',                name: '⚡  openrouter/auto                 — auto-pick best model' },
          { value: 'openrouter/free',                name: '⚡  openrouter/free                 — free tier router' },
          { value: 'openai/gpt-4o',                  name: '   GPT-4o (OpenAI)               [LEGACY]' },
          { value: 'anthropic/claude-3.5-sonnet',    name: '   Claude 3.5 Sonnet              [LEGACY]' },
          { value: 'google/gemini-2.5-pro',          name: '   Gemini 2.5 Pro                 [LEGACY]' },
          { value: 'google/gemini-2.0-flash-001',    name: '   Gemini 2.0 Flash               [DEPRECATED]' },
        ],

        // ── xAI Grok ─────────────────────────────────────────────────────────
        xai: [
          { value: 'grok-4-3',                       name: '★  grok-4-3                       — current flagship (Jun 2026)' },
          { value: 'grok-4-3-latest',                name: '   grok-4-3-latest                — always-latest 4.3 patch' },
          { value: 'grok-build-0.1',                 name: '   grok-build-0.1                — coding agent (fast)' },
          { value: 'grok-3',                         name: '   grok-3                         [DEPRECATED] redirects to 4.3' },
          { value: 'grok-3-mini',                    name: '   grok-3-mini                    [DEPRECATED] redirects to 4.3' },
        ...
        // ── Moonshot AI / Kimi ────────────────────────────────────────────────
        moonshot: [
          { value: 'kimi-k2-0711-preview',           name: '★  kimi-k2-0711-preview           — Kimi K2 latest (2026)' },
          { value: 'kimi-k1.5-preview',              name: '   kimi-k1.5-preview              — K1.5 extended reasoning' },
          { value: 'moonshot-v1-128k',               name: '   moonshot-v1-128k               — 128K ctx' },
          { value: 'moonshot-v1-32k',                name: '   moonshot-v1-32k                — 32K ctx' },
          { value: 'moonshot-v1-8k',                 name: '⚡  moonshot-v1-8k                 — 8K fast / standard' },
        ],

        // ── MiniMax ───────────────────────────────────────────────────────────
        minimax: [
          { value: 'MiniMax-Text-01',                name: '★  MiniMax-Text-01                — flagship · 1M ctx' },
        ...
        local: [
          { value: 'qwen3:32b',                      name: '★  qwen3:32b                      — top reasoning · 20GB VRAM' },
          { value: 'qwen3:14b',                      name: '   qwen3:14b                      — balanced · 10GB' },
          { value: 'qwen3:8b',                       name: '⚡  qwen3:8b                       — fast · 6GB' },
          { value: 'qwen3:4b',                       name: '⚡  qwen3:4b                       — edge · 4GB' },
          { value: 'llama3.3:70b',                   name: '   llama3.3:70b                   — Meta Llama 3.3 · 40GB+' },
          { value: 'llama3.2:11b',                   name: '   llama3.2:11b                   — vision capable · 8GB' },
          ...
          { value: 'mistral-small',                  name: '   mistral-small                  — Mistral Small 24B · 16GB' },
          { value: 'deepseek-r1:32b',                name: '🧠  deepseek-r1:32b                — reasoning · 20GB' },
          { value: 'deepseek-r1:70b',                name: '🧠  deepseek-r1:70b                — reasoning · 40GB+' },
          { value: 'deepseek-v3',                    name: '   deepseek-v3                    — DeepSeek V3' },
          { value: 'llama3:latest',                  name: '   llama3:latest                  [LEGACY] Llama 3 8B' },
          { value: 'mistral:latest',                 name: '   mistral:latest                 [LEGACY] Mistral 7B' },
      ...
      if (aiCompany !== 'none') {
        ...
        if (companyModels.length > 0) {
          ...
          if (modelChoice === '__custom__') {
            const { customModel } = await prompt({ type: 'input', name: 'customModel', message: 'Model name:' });
      ...
      if (alreadyLoggedIn) {
        ...
        if (connectionType === 'firebase') {
          ...
          if (!ghClientId) {
            ...
            try {
              const { accessToken, scope } = await loginInternal.deviceFlowLogin({ clientId: ghClientId, scope: 'read:user repo', log, note });
              const userRes = await fetch('https://api.github.com/user', { headers: { Authorization: `Bearer ${accessToken}`, 'User-Agent': 'AgentOS-CLI' } });
              const user = await userRes.json();
              if (userRes.ok) {
                loginInternal.writeCredentials({ provider: 'github', login: user.login, name: user.name || user.login, avatar: user.avatar_url, accessToken, scope });
