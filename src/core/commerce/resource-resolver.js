...
const RESOURCE_DEFINITIONS = Object.freeze({
  product: Object.freeze({
    ...
    inventoryTable: 'product_inventory',
    identityFields: ['productId', 'sku', 'id'],
  }),
  service: Object.freeze({
    type: 'service',
    catalogTable: 'services',
    inventoryTable: 'service_inventory',
    identityFields: ['serviceId', 'serviceCode', 'id'],
  }),
});
...
export function inventoryTableFor(type) {
  return getResourceDefinition(type).inventoryTable;
}
