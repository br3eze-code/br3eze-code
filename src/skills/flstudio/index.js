...
class FLStudioSkill extends BaseSkill {
  ...
  static description =
    'Control FL Studio via OSC/MIDI: transport, mixer, playlist, patterns, automation';
      ...
      'flstudio.ai': {
        ...
        parameters: {
          ...
          properties: {
            action: {
              type: 'string',
              enum: ['generate_melody', 'generate_chords', 'style_transfer', 'inpaint', 'continue'],
              default: 'generate_melody',
            },
      ...
      'flstudio.ai_master': {
        ...
        parameters: {
          ...
          properties: {
            action: {
              type: 'string',
              enum: ['separate', 'master', 'rebalance'],
              default: 'master',
            },
      ...
      'flstudio.video': {
        ...
        parameters: {
          ...
          properties: {
            action: {
              type: 'string',
              enum: ['load_video', 'load_effect', 'set_param', 'export'],
              default: 'load_effect',
            },
      ...
      'flstudio.sync': {
        ...
        parameters: {
          ...
          properties: {
            action: {
              type: 'string',
              enum: ['set_tc', 'marker_to_frame', 'video_to_audio'],
              default: 'set_tc',
            },
      ...
      'flstudio.visualizer': {
        ...
        parameters: {
          ...
          properties: {
            type: {
              type: 'string',
              enum: ['spectrum', 'wave', 'image', 'text', 'particles'],
              default: 'spectrum',
            },
      ...
      'flstudio.arrangement': {
        ...
        parameters: {
          ...
          properties: {
            action: {
              type: 'string',
              enum: ['generate', 'apply_template', 'analyze'],
              default: 'generate',
            },
            template: {
              type: 'string',
              enum: ['pop', 'edm', 'hiphop', 'rock', 'verse_chorus', 'abacab'],
              default: 'pop',
            },
        ...
        parameters: {
          ...
          properties: {
            sections: {
              type: 'array',
              items: { type: 'object' },
              description: '[{name:"Intro",bars:8},{name:"Verse",bars:16}]',
            },
      ...
      'flstudio.hardware': {
        ...
        parameters: {
          ...
          properties: {
            device: {
              type: 'string',
              enum: ['akai_fire', 'launchpad', 'maschine', 'apc40'],
              default: 'akai_fire',
            },
            action: {
              type: 'string',
              enum: ['pad_led', 'pad_map', 'knob_map', 'display'],
              default: 'pad_led',
            },
      ...
      'flstudio.launchpad': {
        ...
        parameters: {
          ...
          properties: {
            action: {
              type: 'string',
              enum: ['led', 'clear', 'map_clip', 'user_mode'],
              default: 'led',
            },
      ...
      'flstudio.performance': {
        ...
        parameters: {
          ...
          properties: {
            action: {
              type: 'string',
              enum: ['launch_clip', 'launch_scene', 'stop_clip', 'record_clip', 'get_state'],
              default: 'launch_clip',
            },
      ...
      'flstudio.api': {
        ...
        parameters: {
          ...
          properties: {
            module: {
              type: 'string',
              enum: ['transport', 'channels', 'mixer', 'playlist', 'patterns', 'plugins', 'ui'],
              default: 'transport',
            },
      ...
      'flstudio.browse': {
        ...
        parameters: {
          ...
          properties: {
            type: {
              type: 'string',
              enum: ['sample', 'preset', 'project', 'plugin'],
              default: 'sample',
            },
      ...
      'flstudio.patcher': {
        ...
        parameters: {
          ...
          properties: {
            action: {
              type: 'string',
              enum: ['load_preset', 'set_param', 'route', 'macro'],
              default: 'set_param',
            },
      ...
      'flstudio.channel': {
        ...
        parameters: {
          ...
          properties: {
            ...
            action: {
              type: 'string',
              enum: ['select', 'mute', 'solo', 'volume', 'pan', 'param'],
              default: 'select',
            },
            value: { type: 'number' },
      ...
      'flstudio.piano_roll': {
        ...
        parameters: {
          ...
          properties: {
            action: {
              type: 'string',
              enum: ['add_note', 'clear', 'quantize', 'humanize'],
              default: 'add_note',
            },
      ...
      'flstudio.transport': {
        ...
        parameters: {
          ...
          properties: {
            action: {
              type: 'string',
              enum: ['play', 'stop', 'record', 'loop', 'tempo'],
              default: 'play',
            },
      ...
      'flstudio.playlist': {
        ...
        parameters: {
          ...
          properties: {
            action: {
              type: 'string',
              enum: ['play_pattern', 'play_song', 'set_position'],
              default: 'play_pattern',
            },
...
JSON: {"notes":[...]}`,
          ...
          const res = await this.agent.registry.execute(
            'llm.chat',
            { prompt: prompts[args.action], model: 'gpt-4' },
            ctx.userId
          );
          try {
...
JSON: {
  ...
  "targets":{"lufs":${args.target_lufs},"peak":-1.0,"lra":7}
            ...
            try {
              return { action: 'master', ...JSON.parse(res.text) };
            } catch {
        ...
        case 'flstudio.video': {
          ...
          if (args.action === 'export') {
            ...
            return {
              ...
              note: 'Renders to FL Studio/Projects/Rendered',
            };
          }
        }
          break;
        case 'flstudio.sync': {
          ...
          const val =
            args.action === 'set_tc'
              ? JSON.stringify({ tc: args.timecode, fps: args.fps })
              : args.action === 'marker_to_frame'
                ? args.marker
                : 1;
...
JSON: {"sections":[{"name":"Intro","bars":4,"energy":0.2,"clips":["drums"]},{"name":"Verse","bars":8,"energy":0.4}],"total_bars":${args.length}}`;
        ...
        case 'flstudio.structure': {
          ...
          layout.forEach(sec => {
            this._sendOSC(
              '/Playlist/addMarker',
              JSON.stringify({ pos: sec.start, name: sec.name })
            );
            if (args.clips?.[sec.name]) {
              args.clips[sec.name].forEach(pattern => {
                this._sendOSC(
                  '/Playlist/addClip',
                  JSON.stringify({ pattern, pos: sec.start, len: sec.bars })
                );
              });
            }
          });
        ...
        case 'flstudio.hardware': {
          ...
          if (args.action === 'pad_led') {
            ...
            return {
              ...
              pad: args.pad,
              color: args.color,
              address: `${base}/pad/${args.pad}/color`,
            };
          }
        ...
        case 'flstudio.launchpad': {
          ...
          if (args.action === 'clear') {
            for (let x = 0; x < 8; x++)
              for (let y = 0; y < 8; y++) this._sendOSC(`/Launchpad/led/${x}/${y}`, 0);
            return { action: 'clear', pads: 64 };
          }

          if (args.action === 'map_clip') {
            this._sendOSC(
              `/Launchpad/map/${args.x}/${args.y}`,
              JSON.stringify({ track: args.track, clip: args.clip })
            );
        ...
        case 'flstudio.performance': {
          this.logger.info(`FL PERFORMANCE ${args.action} T${args.track}C${args.clip}`, {
            user: ctx.userId,
          });
          const perfMap = {
        ...
        case 'flstudio.mixer_fx': {
          this.logger.info(`FL MIXER_FX T${args.track}S${args.slot} ${args.action}`, {
            user: ctx.userId,
          });
          const fxMap = {
          ...
          const val =
            args.action === 'add' ? args.plugin : args.action === 'bypass' ? args.value : args.slot;
        ...
        case 'flstudio.playlist_marker': {
          ...
          const val =
            args.action === 'add'
              ? JSON.stringify({ pos: args.position, name: args.name, color: args.color })
              : args.position;
        ...
        case 'flstudio.browse': {
          ...
          this._sendOSC(
            browseMap[args.type],
            JSON.stringify({ path: args.path, target: args.target, slot: args.slot })
          );
          return {
            type: args.type,
            path: args.path,
...
`;
          ...
          return {
            ...
            name: args.name,
            path: filePath,
            note: `Copy to: Documents/Image-Line/FL Studio/Settings/Hardware/${args.name}/device_${
              args.name
            }.py`,
        ...
        case 'flstudio.channel': {
          ...
          const val =
            args.action === 'select'
              ? args.channel
              : args.action === 'mute' || args.action === 'solo'
                ? args.value
                  ? 1
                  : 0
                : args.value;
          ...
          return {
            ...
            action: args.action,
            value: val,
            address: channelMap[args.action],
          };
        }
        case 'flstudio.plugin': {
          this.logger.info(`FL PLUGIN ${args.plugin} ${args.param}=${args.value}`, {
            user: ctx.userId,
          });
        ...
        case 'flstudio.mixer': {
          this.logger.info(`FL MIXER T${args.track} ${args.param}=${args.value}`, {
            user: ctx.userId,
          });
        ...
        case 'flstudio.pattern': {
          ...
          if (args.output === 'midi') {
            ...
            steps.forEach((step, i) => {
              if (step === 'x') {
                track.addEvent(
                  new MidiWriter.NoteEvent({ pitch: notes[i % notes.length], duration: dur })
                );
              } else {
        ...
        case 'flstudio.playlist': {
          ...
          const val =
            args.action === 'play_pattern'
              ? args.pattern
              : args.action === 'set_position'
                ? args.position
                : 1;
