  ...
  static getTools() {
    return {
      'music.cognition': {
        ...
        parameters: {
          ...
          properties: {
            ...
            model: {
              type: 'string',
              enum: ['idyll', 'melisma', 'expectation', 'tension', 'groove'],
              default: 'expectation',
            },
          },
          required: [],
      ...
      'music.expectation': {
        ...
        parameters: {
          ...
          properties: {
            ...
            metric: {
              type: 'string',
              enum: ['surprisal', 'entropy', 'probability'],
              default: 'surprisal',
            },
          },
          required: ['sequence'],
      ...
      'music.entrainment': {
        ...
        parameters: {
          ...
          properties: {
            ...
            analysis: {
              type: 'string',
              enum: ['beat', 'meter', 'groove', 'syncopation'],
              default: 'groove',
            },
          },
          required: ['rhythm'],
      ...
      'music.ethno': {
        ...
        parameters: {
          ...
          properties: {
            ...
            aspect: {
              type: 'string',
              enum: ['tuning', 'scale', 'rhythm', 'form', 'all'],
              default: 'all',
            },
      ...
      'music.transcribe': {
        ...
        parameters: {
          ...
          properties: {
            ...
            system: {
              type: 'string',
              enum: ['western', 'ciprian', 'gamelan', 'maqam', 'sargam'],
              default: 'western',
            },
      ...
      'music.tuning': {
        ...
        parameters: {
          ...
          properties: {
            system: {
              type: 'string',
              enum: ['12tet', 'just', 'pythagorean', 'meantone', 'pelog', 'slendro', 'maqam'],
              default: '12tet',
            },
        ...
        parameters: {
          ...
          properties: {
            ...
            features: {
              type: 'array',
              items: { type: 'string' },
              enum: ['onset', 'pitch', 'tempo', 'dynamics', 'articulation', 'all'],
              default: ['all'],
            },
      ...
      'music.gesture': {
        ...
        parameters: {
          ...
          properties: {
            source: {
              type: 'string',
              enum: ['video', 'midi_controller', 'leap', 'kinect'],
              default: 'midi_controller',
            },
            mapping: {
              type: 'string',
              enum: ['tempo', 'dynamics', 'filter', 'spatial'],
              default: 'tempo',
            },
      ...
      'music.schenker': {
        ...
        parameters: {
          ...
          properties: {
            ...
            level: {
              type: 'string',
              enum: ['foreground', 'middleground', 'background', 'all'],
              default: 'all',
            },
          },
          required: ['chords'],
      ...
      'music.set_theory': {
        ...
        parameters: {
          ...
          properties: {
            ...
            operation: {
              type: 'string',
              enum: ['prime', 'vector', 'forte', 'transform'],
              default: 'prime',
            },
            transform: {
              type: 'string',
              enum: ['T0', 'T6', 'I0', 'M', 'MI'],
              description: 'for transform op',
            },
          },
          required: ['notes'],
        },
      ...
      'music.distributed': {
        ...
        parameters: {
          ...
          properties: {
            protocol: {
              type: 'string',
              enum: ['osc', 'midi', 'ableton_link', 'webrtc'],
              default: 'osc',
            },
            action: {
              type: 'string',
              enum: ['send', 'receive', 'sync', 'broadcast'],
              default: 'send',
            },
      ...
      'music.archive': {
        ...
        parameters: {
          ...
          properties: {
            ...
            corpus: {
              type: 'string',
              enum: ['imslp', 'kern', 'essen', 'rime', 'all'],
              default: 'all',
            },
            mode: {
              type: 'string',
              enum: ['search', 'analyze', 'compare', 'attribute'],
              default: 'search',
            },
          },
          required: ['query'],
        ...
        parameters: {
          ...
          properties: {
            ...
            features: {
              type: 'array',
              items: { type: 'string' },
              description: 'extract: harmony, rhythm, melody',
            },
          },
          required: [],
        },
      ...
      'music.live': {
        risk: 'low',
        description:
          'Live coding: TidalCycles, Sonic Pi, Strudel patterns, algorithmic composition',
        parameters: {
          type: 'object',
          properties: {
            engine: {
              type: 'string',
              enum: ['tidal', 'sonicpi', 'strudel', 'foxdot'],
              default: 'tidal',
            },
      ...
      'music.algo_comp': {
        ...
        parameters: {
          ...
          properties: {
            algorithm: {
              type: 'string',
              enum: ['euclidean', 'markov', 'cellular', 'lsystem', 'fibonacci'],
              default: 'euclidean',
            },
      ...
      'music.neuro': {
        ...
        parameters: {
          ...
          properties: {
            signal: {
              type: 'string',
              enum: ['alpha', 'beta', 'theta', 'delta', 'gamma', 'hrv', 'eda'],
              default: 'alpha',
            },
            mapping: {
              type: 'string',
              enum: ['pitch', 'tempo', 'filter', 'amplitude', 'timbre'],
              default: 'pitch',
            },
            range: {
              type: 'array',
              items: { type: 'number' },
              description: 'min,max Hz or value',
              default: [8, 12],
            },
          },
          required: ['signal'],
      ...
      'music.bci': {
        ...
        parameters: {
          ...
          properties: {
            paradigm: {
              type: 'string',
              enum: ['ssvep', 'p300', 'motor', 'attention'],
              default: 'attention',
            },
            channels: { type: 'number', default: 8 },
            control: {
              type: 'string',
              enum: ['tempo', 'filter', 'instrument', 'fx'],
              default: 'tempo',
            },
          },
          required: ['paradigm'],
      ...
      'music.biofeedback': {
        ...
        parameters: {
          ...
          properties: {
            metric: {
              type: 'string',
              enum: ['hrv', 'heart_rate', 'eda', 'emg', 'breath'],
              default: 'hrv',
            },
      ...
      'music.spatial': {
        ...
        parameters: {
          ...
          properties: {
            mode: {
              type: 'string',
              enum: ['binaural', 'ambisonics', 'atmos', 'hrtf'],
              default: 'binaural',
            },
            source_pos: {
              type: 'object',
      ...
      'music.ai_generate': {
        ...
        parameters: {
          ...
          properties: {
            ...
            mode: {
              type: 'string',
              enum: ['text_to_audio', 'style_transfer', 'continuation', 'inpainting'],
      ...
      'music.ai_master': {
        ...
        parameters: {
          ...
          properties: {
            ...
            style: {
              type: 'string',
              enum: ['streaming', 'club', 'vinyl', 'podcast'],
              default: 'streaming',
            },
          },
          required: ['file'],
        ...
        parameters: {
          ...
          properties: {
            ...
            features: {
              type: 'array',
              items: { type: 'string' },
              enum: ['bpm', 'key', 'loudness', 'spectral', 'all'],
              default: ['all'],
            },
          },
          required: ['file'],
      ...
      'music.scale': {
        ...
        parameters: {
          ...
          properties: {
            ...
            type: {
              type: 'string',
              description: 'major, minor, dorian, pentatonic',
              default: 'major',
            },
          },
          required: ['tonic'],
      ...
      switch (toolName) {
        case 'music.cognition': {
          ...
          if (!this.agent.registry.skills.llm)
            throw new Error('Cognition models require llm skill');
...
JSON: {"groove_score":0.82,"syncopation":0.4,"microtiming":"laid_back","entrainment":0.9,"factors":["backbeat","anticipation"]}`,
          ...
          const res = await this.agent.registry.execute(
            'llm.chat',
            { prompt: prompts[args.model], model: 'gpt-4' },
            ctx.userId
          );
          try {
            return { model: args.model, ...JSON.parse(res.text) };
          } catch {
            return { model: args.model, analysis: res.text };
          }
        }
        case 'music.expectation': {
          ...
          const entropy = -seq.reduce(
            (sum, s) => sum + s.probability * Math.log2(s.probability),
            0
          );
          ...
          return {
            ...
            mean_surprisal: (
              seq.reduce((s, x) => s + parseFloat(x.surprisal), 0) / seq.length
            ).toFixed(2),
        ...
        case 'music.entrainment': {
          ...
          const regularity =
            1 -
            Math.sqrt(iois.reduce((s, i) => s + Math.pow(i - meanIOI, 2), 0) / iois.length) /
              meanIOI;
        ...
        case 'music.ethno': {
          ...
          if (!this.agent.registry.skills.llm)
            throw new Error('Ethnomusicology requires llm skill');
...
JSON: {
  ...
  "aesthetics":{"timbre":"bright","density":"layered"}
          ...
          try {
            ...
            return { tradition: args.tradition, analysis: res.text };
          }
        }
...
JSON: {
  ...
  "note":"Auto-transcription approximate. Verify pitch/time."
          ...
          try {
            ...
            return { file: args.file, transcription: res.text };
          }
        }
        case 'music.tuning': {
          ...
          const systems = {
            ...
            pythagorean: {
              ...
              ratios: Array(12)
                .fill(0)
                .map((_, i) => Math.pow(3 / 2, i) * Math.pow(2, -Math.floor(i * Math.log2(3 / 2)))),
              name: 'Pythagorean',
            },
...
JSON: {"dataset":"CIPIC/KEMAR","subject":"021","itd_func":"azimuth*0.0006","ild_func":"azimuth*0.05","pinna_filter":true}`,
          ...
          const res = await this.agent.registry.execute(
            'llm.chat',
            { prompt: prompts[args.mode], model: 'gpt-4' },
            ctx.userId
          );
          try {
            return { mode: args.mode, ...JSON.parse(res.text) };
          } catch {
            return { mode: args.mode, specs: res.text };
          }
        }
        case 'music.ai_stems': {
          this.logger.info(`MUSIC AI_STEMS ${args.stems.join(',')} ${args.model}`, {
            user: ctx.userId,
          });
          ...
          return {
            ...
            command:
              args.model === 'demucs'
                ? `demucs -n htdemucs_ft ${args.file}`
                : `spleeter separate -p spleeter:4stems -o output ${args.file}`,
        ...
        case 'music.distributed': {
          this.logger.info(`MUSIC DISTRIBUTED ${args.protocol} ${args.action}`, {
            user: ctx.userId,
          });
        ...
        case 'music.clock': {
          ...
          return {
            ...
            note:
              args.action === 'tap' ? 'Tap 4 times, avg intervals' : 'Share sync_token with peers',
          };
        }
        case 'music.archive': {
          this.logger.info(`MUSIC ARCHIVE ${args.mode} ${args.corpus}: ${args.query}`, {
            user: ctx.userId,
          });
...
JSON: {"attribution":{"composer":"Mozart","confidence":78},"features":{"melodic_intervals":"small","chromaticism":"low","form":"sonata"},"alternatives":[{"composer":"Haydn","confidence":65}]}`,
          ...
          try {
            return { mode: args.mode, corpus: args.corpus, ...JSON.parse(res.text) };
          } catch {
            return { query: args.query, results: res.text };
          }
        }
        case 'music.style': {
...
JSON: {
  ...
  "url":"kern.humdrum.org"
          ...
          try {
            ...
            return { work: args.work, analysis: res.text };
          }
        }
        case 'music.ai_generate': {
          this.logger.info(`MUSIC AI_GENERATE ${args.mode} ${args.duration}s`, {
            user: ctx.userId,
          });
...
JSON: {
  ...
  "note":"Use Meta AudioCraft or MusicGen"
          ...
          try {
            ...
            return { prompt: args.prompt, generation: res.text };
          }
        }
        case 'music.ai_master': {
          this.logger.info(`MUSIC AI_MASTER ${args.style} ${args.target_lufs}LUFS`, {
            user: ctx.userId,
          });
...
JSON: {
  ...
  "reference_match":${!!args.reference_file}
        ...
        case 'music.neuro': {
          ...
          if (!this.agent.registry.skills.llm)
            throw new Error('Neuro sonification requires llm skill');
...
JSON: {
  ...
  "note":"Higher ${args.signal} → higher ${args.mapping}"
          ...
          try {
            ...
            return { signal: args.signal, mapping: res.text };
          }
        }
        case 'music.bci': {
          ...
          const paradigms = {
            ssvep: {
              freqs: [8, 10, 12, 15],
              note: 'Stare at flicker → select instrument',
              latency: '2-5s',
            },
            p300: { target: 'oddball', note: 'Attend to trigger → play note', latency: '300ms' },
            motor: {
              imagery: 'left/right hand',
              note: 'Imagine movement → pan/modulate',
              latency: '1-2s',
            },
            attention: {
              metric: 'alpha suppression',
              note: 'Focus → increase tempo/brightness',
              latency: '0.5s',
            },
          };
        ...
        case 'music.biofeedback': {
          ...
          const mappings = {
            hrv: {
              relax: 'higher HRV → slower tempo, warmer timbre',
              focus: 'stable HRV → steady rhythm',
              energize: 'lower HRV → faster tempo',
            },
            heart_rate: {
              relax: 'lower HR → lower pitch, slower',
              focus: 'stable HR → metronome',
              energize: 'higher HR → faster, brighter',
            },
            eda: {
              relax: 'lower EDA → less dissonance, more reverb',
              focus: 'stable EDA → clear tone',
              energize: 'higher EDA → distortion',
            },
            breath: {
              relax: 'slow breath → long pads',
              focus: 'rhythmic breath → sync tempo',
              energize: 'fast breath → arps',
            },
          };
          ...
          return {
            ...
            protocol:
              args.target === 'relax'
                ? 'Reduce tempo 5 BPM/min, lowpass 2kHz, increase reverb'
                : args.target === 'focus'
                  ? 'Lock tempo 60-70 BPM, minimal variation, pink noise'
                  : 'Increase tempo 5 BPM/min, add harmonics, reduce reverb',
          };
        }
        case 'music.melodyne': {
          this.logger.info(`MUSIC MELODYNE ${args.correction} ${args.strength}`, {
            user: ctx.userId,
          });
          const corrections = {
            pitch: {
              retune_speed: args.strength,
              scale: args.scale || 'chromatic',
              formant: false,
              note_transition: args.strength,
            },
          ...
          try {
            ...
            if (args.features.includes('bpm') || args.features.includes('all')) {
              if (this.agent.registry.skills.llm) {
                ...
                try {
                  result.bpm = JSON.parse(res.text);
                } catch {
                  result.bpm_note = res.text;
                }
              }
            }
            ...
            if (args.features.includes('key') || args.features.includes('all')) {
              if (this.agent.registry.skills.llm) {
                ...
                const res = await this.agent.registry.execute('llm.chat', { prompt }, ctx.userId);
                try {
                  result.key = JSON.parse(res.text);
                } catch {
                  result.key_note = res.text;
                }
              }
            }
            ...
            if (args.features.includes('loudness') || args.features.includes('all')) {
              result.loudness = {
                ...
                peak_db: -1.0,
                dynamic_range: 8,
                note: 'Estimated. Use ffmpeg for exact LUFS',
              };
            }
...
JSON: {
  ...
  "grid": "steady"
          ...
          try {
            ...
            return { beats: res.text, note: 'Use librosa/essentia for precise detection' };
          }
        }
...
JSON: {
  ...
  "notes":"Play low octaves, monophonic"
        ...
        case 'music.fx_chain': {
          this.logger.info(`MUSIC FX_CHAIN ${args.purpose} ${args.instrument}`, {
            user: ctx.userId,
          });
...
JSON: {
  ...
  "purpose":"","notes":""
        ...
        case 'music.progression': {
          this.logger.info(`MUSIC PROGRESSION ${args.key} ${args.progression}`, {
            user: ctx.userId,
          });
...
Output only lyrics, no explanation.`;
        ...
        case 'music.analyze': {
          ...
          // Detect key
          const possibleKeys = Object.keys(Key.majorKey('C')).filter(
            k => k.length === 1 || k.length === 2
          );
          const keyScores = possibleKeys
            .map(k => {
        ...
        case 'music.harmonize': {
          ...
          const harmonized = args.melody.map(note => {
            ...
            const best =
              chordChoices.find(c => Math.abs(c.degree - degree) <= 2) || chordChoices[0];
