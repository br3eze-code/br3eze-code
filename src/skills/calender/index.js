...
class OutlookCalendarAdapter extends BaseCalendarAdapter {
  ...
  async createEvent(event) {
    ...
    const response = await axios.post(`${this.baseUrl}/me/events`, eventBody, {
      headers: {
  ...
  async listEvents(start, end) {
    ...
    const response = await axios.get(`${this.baseUrl}/me/calendarview?${params.toString()}`, {
      headers: {
        Authorization: `Bearer ${this.accessToken}`,
      },
    });
  ...
  async deleteEvent(id) {
    ...
    await axios.delete(`${this.baseUrl}/me/events/${id}`, {
      headers: {
        Authorization: `Bearer ${this.accessToken}`,
      },
    });
  ...
  async updateEvent(id, event) {
    ...
    const response = await axios.patch(`${this.baseUrl}/me/events/${id}`, eventBody, {
      headers: {
        Authorization: `Bearer ${this.accessToken}`,
        'Content-Type': 'application/json',
      },
