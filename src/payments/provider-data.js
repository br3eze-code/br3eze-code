/**
 * Domain-neutral provider reference data.
 * Commercial rates are deliberately empty until sourced and contract-confirmed.
 * Status describes repository integration/catalog state, not merchant approval.
 */
