...
const create_agent = {
  ...
  parameters: {
    ...
    properties: {
      ...
      roles: {
        type: 'string',
        default: 'operator',
        description: 'Comma list: netops,security,auditor',
      },
      duties: { type: 'string', default: 'monitor,maintain', description: 'Comma list of duties' },
      tools: {
        type: 'string',
        default: 'routeros-api,gateway',
        description: 'Comma list of tools',
      },
  ...
  run: async (
    ...
    let agents = {};
    try {
      agents = JSON.parse(await fs.readFile(agentsPath, 'utf8'));
    } catch {}
